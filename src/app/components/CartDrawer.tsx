...
export function CartDrawer({
  ...
  // Não deu pra confirmar a distância automaticamente (endereço não geocodifica no
  // OpenStreetMap — comum em bairro periférico) — trata com a mesma cautela de um
  // endereço longe, em vez de assumir que está tudo normal.
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground text-xs mt-1 leading-relaxed">
                            {isFarDelivery
                              ...
                              : "Não conseguimos localizar esse endereço automaticamente no mapa pra calcular a distância. Seu pedido será enviado normalmente e a gente confirma o valor do frete e o tempo de entrega com você assim que possível."}
                          </p>
                        </div>
                      </div>
                    )}
                    ...
                    <p className="text-foreground text-base leading-relaxed">
                      {isFarDelivery
                        ? <>Seu pedido foi emitido normalmente. Como seu endereço fica a mais de {FAR_DELIVERY_KM_THRESHOLD} km do
                          ...
                          assim que possível, retornamos por aqui (WhatsApp) com o valor certinho e o tempo de entrega.</>
                        : <>Seu pedido foi emitido normalmente. Não conseguimos localizar seu endereço automaticamente no mapa
                          pra calcular a distância, então vamos avaliar com nossos parceiros de entrega e confirmar o valor do
                          frete com você — assim que possível, retornamos por aqui (WhatsApp) com o preço e o tempo de entrega.</>}
                    </p>
